...
(def simple-list-jsonld2 {"@context" {"mylist2" {"@id" "http://example.com/mylist2" "@container" "@list"}}
                          "mylist2" "one item"})
(def simple-list-jsonld3 {"@context" {"mylist1" {"@id" "http://example.com/mylist1" "@container" "@list"}}
                          "mylist1" {"@list" []}})
...
(facts "list expansion works per the spec"
  ...
  (parse-string (json-ld/expand simple-list-jsonld3)) => [{"http://example.com/mylist1" [{"@list" []}]}])